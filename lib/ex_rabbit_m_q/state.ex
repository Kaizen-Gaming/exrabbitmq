defmodule ExRabbitMQ.State do
  ...
  @spec set_connection_config(config :: ConnectionConfig.t() | nil) :: any
  ...
  @spec set_connection_pid(connection_pid :: pid | nil) :: any
  ...
  @spec set_channel_ripper_pid(channel_ripper_pid :: pid | nil) :: any
  ...
  @spec set_channel_info(channel :: %AMQP.Channel{} | nil, channel_monitor :: reference | nil) :: any
  ...
  @spec set_queue_config(config :: QueueConfig.t()) :: any
